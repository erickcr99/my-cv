    ...
    <>
      ...
      <section id="about" className="hero-section">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="hero-label">Machine Learning Engineer</div>
          ...
          <p className="hero-subtitle">
            Building intelligent systems at the intersection of software engineering and AI research.
            Currently at <strong>Ford México</strong>, pursuing an M.Sc. in CS at <strong>UNAM</strong>.
          </p>
          ...
          <div className="about-grid">
            <div>
              ...
              <p className="about-text">
                Innovative and results-driven Machine Learning Engineer with over 3 years of experience combining
                software development and data analysis to design and implement AI solutions in both industrial and academic settings.
              </p>
              <p className="about-text">
                Specializing in predictive modeling, natural language processing, computer vision, and reinforcement learning,
                with a proven track record of enhancing operational efficiency at Ford Mexico.
              </p>
              <p className="about-text">
                Currently pursuing a Master&apos;s in Computer Science with a specialization in Artificial Intelligence at IIMAS, UNAM,
                with strong expertise in Python, SQL, and deep learning frameworks.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="edu-grid">
            <div className="edu-card edu-card-primary">
              ...
              <p className="edu-card-date">Expected: July 2025</p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="projects-grid">
            ...
            <div className="project-card">
              ...
              <h3 className="project-card-title">Computer Vision</h3>
              <p className="project-card-desc">
                Object detection and classification system using Python and OpenCV for automated monitoring projects.
              </p>
            </div>
            ...
            <div className="project-card">
              ...
              <h3 className="project-card-title">Natural Language Processing</h3>
              <p className="project-card-desc">
                Tokenization, entity recognition, and sentiment analysis with Spacy and NLTK.
                Transformer models for text summarization and classification.
              </p>
            </div>
            ...
            <div className="project-card">
              ...
              <h3 className="project-card-title">Reinforcement Learning</h3>
              <p className="project-card-desc">
                Q-learning and policy gradients to develop adaptive learning agents in simulated environments.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="skills" className="section-container">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="skills-grid">
            ...
            <div className="skill-group">
              <h3 className="skill-group-title">DevOps & Cloud</h3>
              <div className="skill-tags">
      ...
      <footer className="footer">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="footer-copy">&copy; 2025 Alejandro Erick Cano Rosas</p>
